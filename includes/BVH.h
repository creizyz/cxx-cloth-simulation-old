...
struct CollisionData_Triangle
{
  ...
  CollisionData_Triangle(size_t i1, size_t i2, size_t i3, float m1, float m2, float m3) : i{ i1, i2, i3 }, m{ m1, m2, m3 } {}
...
struct CollisionData_Edge
{
  ...
  CollisionData_Edge() {}
  CollisionData_Edge(size_t i1, size_t i2, float m1, float m2) : i{ i1, i2 }, m{ m1, m2 } {}
  void updateData(LinearMotionSystem & _lms)
  {
...
struct CollisionData_Point
{
  ...
  CollisionData_Point() {}
  CollisionData_Point(size_t lms_indice, float mass) : i(lms_indice), m(mass) {}
  CollisionData_Point(size_t lms_indice, float mass, const math::vec3 & position, const math::vec3 & velocity) : i(lms_indice), m(mass), p(position), v(velocity) {}
  void updateData(LinearMotionSystem & _lms)
  {
...
struct ClothCollisionModel
{
  ...
  ClothCollisionModel(LinearMotionSystem & lms) : _lms(lms), root(nullptr) {}
  ~ClothCollisionModel()
  {
    SAFE_DELETE(root);
